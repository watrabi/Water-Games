<?php define("tabname","Apps"); ?>
<?php include_once("base/header.php"); ?>
<div class="main" id="main">
    <h1><?php echo tabname; ?></h1>
    <h2>Here are some of the top apps!</h2>
    ...
    <script>
        ...
        function fetchGames(page) {
            var url = '/api/getapps.php?page=' + page;
            ...
            xhttp.onreadystatechange = function () {
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    games.forEach(function (game) {
                        ...
                        gameLink.href = '/use-app?id=' + game.id;
                        ...
                        gamePlays.innerHTML = game.plays + ' Uses';
