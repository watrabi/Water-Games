...
$query = 'SELECT SQL_CALC_FOUND_ROWS id, name, plays, icon FROM apps LIMIT :offset, :limit';
...
try {
    ...
    foreach ($games as &$game) {
        $game['icon'] = !empty($game['icon']) ? '/assets/img/' . $game['icon'] : '/assets/img/placeholder.png'; // Provide a default icon URL if the icon field is empty
    }
